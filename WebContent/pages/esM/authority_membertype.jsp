...
//数组去重
	...
	function get_authorized_itembank(){
		...
		dataType : "json",
		async : false,
		url : "GetAuthorizedItembankBymembertypeAction?member="+member,
		success : function(result) {
			result = eval(result);
	...
	function SaveConfig(){
		...
		function SaveConfig(){
			...
			$.ajax( {
				...
				dataType : "json",
				async : false,
				url : "SaveAuthorityConfigBymembertypeSelectcourseAction?authorized_es="+authorized_es+"&member="+member+"&courseid="+course_id+"&majorid="+major_id,
				success : function(responseText, statusText) {
					alert(responseText.message);
					document.location.href = "authority_membertype.jsp";
				},
				error:function(){
				}
			});
		...
		$.ajax( {
			...
			dataType : "json",
			async : false,
			url : "SaveAuthorityConfigBymembertypeSelectnonecourseAction?authorized_es="+authorized_es+"&member="+member+"&majorid="+major_id,
			success : function(responseText, statusText) {
				alert(responseText.message);
				document.location.href = "authority_membertype.jsp";
			},
		...
		$.ajax( {
			...
			dataType : "json",
			async : false,
			url : "SaveAuthorityConfigBymembertypeAction?authorized_es="+authorized_es+"&member="+member,
			success : function(responseText, statusText) {
				alert(responseText.message);
				document.location.href = "authority_membertype.jsp";
			},
