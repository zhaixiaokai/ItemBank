...
function	KnowledgeList(){
	...
	$.ajax( {
		...
		success : function(result) {
			...
			for(var	i=0;i<result.data.length;i++){
					document.getElementById("TD_"+result.data[i].chapter_id).innerHTML+="<br>"+"<input name=\"kpCheckbox\" id='IP_"+result.data[i].knowledge_point_id
					+"' type='checkbox' />&nbsp;&nbsp;&nbsp;"
								...
								<fieldset style="height: 100%;">
									...
									<table>
										...
										<tr>
											...
											<td>选择教材： <select id="SelectTM" name="SelectTM"><option
														value="" selected="selected">--请选择--</option>
											</select></td>
										</tr>
										<tr height="50px">
