...
function	QureyResultOnTeachingClass(){
	...
	CreateDataTableForStudentScore(selectedCurseId,SelectedTeachingClassId);
}

//根据查询条件生成学生成绩表格
function CreateDataTableForStudentScore(selectedCurseId,SelectedTeachingClassId){
	(function () {
		var timestamp = (new Date()).valueOf();  
	    var myDataSource = new YAHOO.util.DataSource("StudentScoreOnTeachingClassGetAction?selectedCurseId="+selectedCurseId+"&SelectedTeachingClassId="+SelectedTeachingClassId+"&timestamp="+timestamp+"&");  
...
function DeleteRow(Id,selectedCurseId){
	...
	if(confirm("确定要删除该记录？")){
		$.ajax({
			...
			dataType : "json",
			async : false,
			url : "StudentScoreDeleteOnTeachingClassAction",
			data:{
				"DeleteId":Id,
...
function ModifyRow(Id,Score){
    ...
    document.getElementById("SelectedTeachingClassId").value=SelectedTeachingClassId;
		...
		<table border="0" cellpadding="2" cellspacing="1"
			...
			<tr>
				...
				<td width="40"><input type="button"
					value="查询" onclick="QureyResultOnTeachingClass();"></td>
			</tr>
		...
		<div id="container">
			<div id="panel1" style="z-index: 1999">
				...
				<div class="bd" style="z-index: 2000">
					<form name="modifyForm" action="StudentScoreUpdateOnTeachingClassAction"
						id="modifyForm">
						<input type="hidden" name="selectedCurseId" id="selectedCurseId" />
						<input type="hidden" name="SelectedTeachingClassId" id="SelectedTeachingClassId"/>
