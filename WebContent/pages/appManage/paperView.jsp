...
<body>
	...
	<!-- 右侧界面 -->
	<div id="act_top"><a href="../../functionList/HomePage.html">应用管理&gt;&gt;</a><a href="../../functionList/sysManage.html">组卷管理</a>&nbsp;&gt;&gt;&nbsp;手动组卷&gt;&gt;&nbsp;组卷预览</div>
...
<table width="100%">
	<tr>
		<td align="right"><input type="button" value="继续添加" class="button" onclick="window.history.go(-1);"/><input type="button" value="批量删除" class="button"/></td>	
	</tr>
</table>
...
<div style="text-align:center">
  <input type="button" name="Submit" value="试卷预览" class="button"/>
