...
<body>
	...
	<!-- 右侧界面 -->
	<div id="act_top">
		<a href="javascript:void(0)">试题库管理</a>&nbsp;&gt;&gt;&nbsp;<a href="javascript:void(0)">试题库管理</a>&nbsp;&gt;&gt;&nbsp;<a
			href="javascript:void(0)">试题库管理</a>
	</div>
	...
	<div style="margin-left:40px;">
		<table border="0" style="width: 100%">
			<tr>
				<td align="left" style="font-size: 12px">当前分类体系：基本分类体系&nbsp;&nbsp;&nbsp;<input
					type="button" name="select" value="更改" class="button"
				...
				<li class="Opened" id="treeL1"><a href="javascript:void(0)"
					...
					<ul >
						<li id="treeL2"><a href="javascript:void(0)"
							...
							class=s src="../source/ad.png" />概率论</span></a>
									<ul>
										<li id="treeL4"><a href="javascript:void(0)" id="A3"><span><img
													class=s src="../source/2.gif">试题库a</span></a></li>
										<li id="treeL4"><a href="javascript:void(0)" id="A3"><span><img
													class=s src="../source/2.gif">试题库b</span></a></li>
										
									</ul></li>
								<li id="treeL3"><a href="javascript:void(0)"
							onclick="javascript:ChangeStatus(this);" id="A2"><span><img
							class=s src="../source/ad.png" />英语</span></a>
									<ul>
										<li id="treeL4"><a href="javascript:void(0)" id="A3"><span><img
													class=s src="../source/2.gif">试题库a</span></a></li>
										<li id="treeL4"><a href="javascript:void(0)" id="A3"><span><img
					...
					<ul >
						<li id="treeL2"><a href="javascript:void(0)"
							...
							class=s src="../source/ad.png" />概率论</span></a>
								...
								<li class="Child" id="treeL3"><a href="javascript:void(0)"
							onclick="javascript:ChangeStatus(this);" id="A2"><span><img
							class=s src="../source/ad.png" />英语</span></a>
									<ul>
										<li id="treeL4"><a href="javascript:void(0)" id="A3"><span><img
