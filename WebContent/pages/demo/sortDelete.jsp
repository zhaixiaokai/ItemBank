...
<body>
	<div id="act_top"><a href="#">试题库分类管理</a>&nbsp;&gt;&gt;&nbsp;<a href="#">删除分类体系</a></div>
	...
	<table>
		<tr>
			<td style="border:0;height:50px" >
	  			<table width="100%" style="font-size:12px">
	  				<tr >
						<td width="5%"><img src="image/refer.gif" width="20" height="18" /></td>
						<td width="35%" align=left>请输入分类体系关键字：<input type="text" id="keyword" name="keyword" size=10></td>
						<td width="10%" align=left><input type=button id="button" name="button" value="查询" class="button1"></td>
						<td width="50%" align=right><input type=button id="button" name="button" value="批量删除" class="button"></td>
					</tr>		
	  			</table>
	  		</td>
		</tr>
		<tr>
	  	...
	  	<tr><td style="border:0">
	  		<table>
	  			<tr><td style="border:0;font-size:12px">
