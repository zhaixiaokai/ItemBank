				...
				<td width="100%">
					<table width="100%">
				        ...
				        <span class="red"> *</span></td>
										...
										<tr>
											...
											<td><select name="select2" style="font-size: 12px"
												disabled>
													...
													<option>选择题</option>
													<option>填空题</option>
													<option selected="selected">判断题</option>
													<option>简答题</option>
											</select></td>
										</tr>
										<tr>
										...
										<tr>
											<td nowrap align="right" height="20px">试题答案:</td>
											<td colspan="3"><input type="radio" id="yes"
												name="radio">正确 &nbsp;&nbsp;&nbsp;&nbsp; <input
												type="radio" id="no" name="radio">错误
												&nbsp;&nbsp;&nbsp;&nbsp;</td>
										</tr>
										<tr>
											<td nowrap align="right" height="40px">备注信息:</td>
											<td colspan="3"><textarea id="textarea" name="textarea"
													rows="4" cols="70"></textarea></td>
										</tr>
									</table>
