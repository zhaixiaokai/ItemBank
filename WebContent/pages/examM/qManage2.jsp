		...
		<table width="700px" height=50px>
			<tr>
				...
				<td width=""><input type=button id="button" value="查询"
					class="button"></td>
				<td width=""><input type=button id="button" value="批量删除"
					class="button"></td>
			</tr>
		</table>
					...
					<table>
						<tr>
							<td style="font-size: 12px; border: 0;"><a
								href="qManage1.jsp" class="page">首页</a> &nbsp;&nbsp; <a
								href="qManage1.jsp" class="pageturn" style="font-size: 12px">&nbsp;<
									上一页 </a> <a href="qManage1.jsp" class="page">&nbsp;1&nbsp;</a> <a
								href="qManage2.jsp" style="color: red; text-decoration: none;">&nbsp;2&nbsp;</a>
								<a href="qManage3.jsp" class="page">&nbsp;3&nbsp;</a> <a
								href="javascript:void(0)" class="page">&nbsp;4&nbsp;</a> <a
								href="javascript:void(0)" class="page">&nbsp;5&nbsp;</a> <a
								href="qManage3.jsp" class="pageturn" style="font-size: 12px">&nbsp;下一页
