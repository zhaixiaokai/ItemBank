...
function	CreateDataTableForQues(){
	...
	//    var myDataSource = new YAHOO.util.DataSource("QuesViewTableSourceAction?itembank_id="+itembank_id);  
	    ...
	    // 自定义内容格式化方法   
	    YAHOO.widget.DataTable.Formatter.QuesMove = function(elCell, oRecord, oColumn, oData){
             ...
             elCell.innerHTML="<a href='#' onclick=QuesMove('"+id+"')>迁移 </a>";
	    }  
	 /*    YAHOO.widget.DataTable.Formatter.QuesDelete = function(elCell, oRecord, oColumn, oData){
	    ...
	    var myColumnDefs = [  
	                   ...
	                   //     {key:"itembank", label:"试题库"},
	                        {key:'试题迁移', lable:"",formatter:"QuesMove"}
...
//试题迁移
function QuesMove(id){
	document.location.href="QuesMoveTargetEs.jsp?questionid="+id+"&itembank_id="+itembank_id;
}
</script>
...
<body class=" yui-skin-sam" >
	...
	<div id="act_top">
		<a href="javascript:void(0)">试题管理</a>&nbsp;&gt;&gt;&nbsp;<a
			href="javascript:void(0)">试题管理</a>&nbsp;&gt;&gt;&nbsp;试题迁移
	</div>
