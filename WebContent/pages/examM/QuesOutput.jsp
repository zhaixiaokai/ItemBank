...
function	CreateDataTableForQues(){
	...
	//    var myDataSource = new YAHOO.util.DataSource("QuesViewTableSourceAction?itembank_id="+itembank_id);  
	    ...
	    // 自定义内容格式化方法   
	    YAHOO.widget.DataTable.Formatter.QuesOutput = function(elCell, oRecord, oColumn, oData){
             ...
             elCell.innerHTML="<a href='#' onclick=QuesOutput('"+id+"')>导出 </a>";
	    }  
	 /*    YAHOO.widget.DataTable.Formatter.QuesDelete = function(elCell, oRecord, oColumn, oData){
	    ...
	    var myColumnDefs = [  
	                   ...
	                   //     {key:"itembank", label:"试题库"},
	                        {key:'试题导出', lable:"",formatter:"QuesOutput"}
...
//试题迁移
function QuesOutput(id){
	var htmlName=null;
	$.ajax( {
		type : "post",
		dataType : "text",
		async : false,
		url : "QuesOutputAction?questionid="+id+"&itembank_id="+itembank_id,
		success : function(result) {
			DocName=result;
		},
		error:function(){
...
<body class=" yui-skin-sam" >
	...
	<div id="act_top">
		<a href="javascript:void(0)">试题管理</a>&nbsp;&gt;&gt;&nbsp;<a
			href="javascript:void(0)">试题管理</a>&nbsp;&gt;&gt;&nbsp;试题导出
	</div>
