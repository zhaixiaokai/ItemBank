...
<body>
	...
	<script type="text/javascript">
var dataUrl = '<%= request.getParameter("fileToBeRead") %>';
 alert(dataUrl);
Ext.define('Model', {
    extend: 'Ext.data.Model',
    idProperty: 'Model',
    fields: ['姓名','性别','column3','id']        
});
...
var grid=Ext.create('Ext.grid.Panel',{
	...
	columns:[
	         ...
	         {header:"uname",dataIndex:'姓名',width:150},
	         {header:"bumen",dataIndex:'性别',width:150},
