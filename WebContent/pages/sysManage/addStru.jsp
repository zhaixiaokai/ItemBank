						...
						<td>
							<form id="myForm">
								<fieldset style="height: 100%;">
									<legend style="font-size: 12px">添加部门</legend>
									<table border="0" cellpadding="2" cellspacing="1"
										...
										<tr>
											<td nowrap align="left" height="30px">部门名称:</td>
											<td colspan="3"><input type="text" name="textfield"
												id="textfield" /><span class="red"> *</span></td>
										</tr>
										<tr>
										...
										<tr>
											<td nowrap align="left" height="30px">职责说明:</td>
											<td colspan="3"><input type="text" name="textfield"
												id="textfield" /></td>
										</tr>
