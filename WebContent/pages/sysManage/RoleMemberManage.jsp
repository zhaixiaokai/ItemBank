...
function DeleteRow(o){
	...
	if(confirm("确定要删除该记录？")){
		$.ajax({
			...
			dataType : "json",
			async : false,
			url : "RoleMemberDeleteAction?DeleteId="+id,
			success : function(result) {
				alert(result.text);
				//删除完成后重新载入数据表~
				getRoleListId();
...
<body class=" yui-skin-sam">
	...
	<div id="act_top">
		<a href="../functionList/HomePage.html">首页</a>&nbsp;&gt;&gt;&nbsp;<a
			...
			href="javascript:void(0)">角色成员管理</a>
	</div>
	...
	<div id="act_content2">
		<table width="100%" class="CContent">
			<tr>
				...
				</select><input type="hidden" name="RoleListId"
					id="RoleListId" value="">
				</td>
				...
				<td width="40px"><input type="button" value="查询" class="button"
					onclick="getRoleListId();" /></td>
