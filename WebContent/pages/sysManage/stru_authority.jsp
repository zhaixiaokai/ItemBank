...
<body>
	...
	<div id="act_content2">
		<table width="700px" height="50px">
			<tr>
				<td><label for="授权部门列表">机构列表：</label> <select name="授权部门列表"
					id="授权部门列表">
				...
				</select> <label for="授权部门列表">授权中心列表：</label> <select name="授权部门列表"
					id="授权部门列表">
						<option value="信息与通信学院">泛网无线教研中心</option>
						<option value="计算机学院">网络搜索教研中心</option>
