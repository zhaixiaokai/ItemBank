						...
						<td>
							<form id="myForm">
								<fieldset style="height: 100%;">
									<legend style="font-size: 12px">修改配置项</legend>
									<table border="0" cellpadding="2" cellspacing="1"
										...
										<tr>
											<td nowrap align="left" height="60px">唯一标识符:</td>
											<td colspan="3"><input type="text" name="textfield"
												id="textfield" /></td>
										</tr>
										<tr>
											<td nowrap align="left" height="50px">配置项名称:</td>
											<td colspan="3"><input type="text" name="textfield"
												id="textfield" /></td>
										</tr>
										<tr>
											<td nowrap align="left" height="50px">配置项值:</td>
