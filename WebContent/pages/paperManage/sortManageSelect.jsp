...
<script>
	function sortSelect() {
		self.parent.frames["mainFrame"].location = "sortManage.jsp";
	}
	function showDiv() {
...
<body>
	...
	<div style="margin-left: 25px; margin-top: 10px">
		...
		<div id="div" style="visibility: hidden">
			...
			<div id="treebody" style="margin-left: 25px; margin-top: 10px;margin-right:20px">
								...
								<li id="treeL2"><a href="javascript:void(0)"
									...
									<ul>
										<li id="treeL3"><a href="javascript:void(0)" id="A2"><span><img
													class=s src="../source/2.gif" />概率论</span></a></li>
										<li id="treeL3"><a href="javascript:void(0)" id="A2"><span><img
													class=s src="../source/2.gif" />英语</span></a></li>
							...
							<ul>
								<li id="treeL2"><a href="javascript:void(0)"
									...
									<ul>
										<li id="treeL3"><a href="javascript:void(0)" id="A2"><span><img
													class=s src="../source/2.gif" />概率论</span></a></li>
										<li class="Child" id="treeL3"><a
											href="javascript:void(0)" id="A2"><span><img
													class=s src="../source/2.gif" />英语</span></a></li>
