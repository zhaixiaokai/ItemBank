...
//数组去重
	...
	function get_authorized_epdb(){
		...
		dataType : "json",
		async : false,
		url : "GetAuthorizedEPDBBymembertypeAction?member="+member,
		success : function(result) {
			result = eval(result);
	...
	function SaveConfig(){
		...
		$.ajax( {
			...
			dataType : "json",
			async : false,
			url : "SaveEPDBAuthorityConfigBymembertypeSelectcourseAction?authorized_epdb="+authorized_epdb+"&member="+member+"&courseid="+course_id+"&majorid="+major_id,
			...
			$.ajax( {
				...
				dataType : "json",
				async : false,
				url : "SaveEPDBAuthorityConfigBymembertypeSelectnonecourseAction?authorized_epdb="+authorized_epdb+"&member="+member+"&majorid="+major_id,
				success : function(responseText, statusText) {
					alert(responseText.message);
					document.location.href = "authority_membertype.jsp";
				},
