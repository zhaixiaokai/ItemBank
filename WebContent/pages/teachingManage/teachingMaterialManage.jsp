...
<body>
	...
	<!-- 右侧界面 -->
	<div id="act_top">
		<a target="mainFrame" href="../functionList/teachingManage.jsp">教学管理</a>&nbsp;&gt;&gt;&nbsp;教材管理<a href="teachingMaterialManage.jsp">&nbsp;&gt;&gt;&nbsp;教材管理</a></div>
...
<div id="act_content2">
  ...
  <tr align="center">
    ...
    <td>第三版</td>
    <td>外语教学与研究出版社</td>
    <td>978-7-111-32501-7</td>
    <td><a href="TMMedit.jsp">修改</a>&nbsp;/&nbsp;<a href="javascript:void(0)">删除</a></td>
  </tr>
  <tr align="center">
