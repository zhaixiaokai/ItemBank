...
function CheckValidationAndQueryTeachingMaterial(){
	...
	window.location.href='TeachingProgressTree.jsp?SelectedCourseId='+SpecialFieldId;
...
<body class=" yui-skin-sam">
	...
	<!-- 右侧界面 -->
	<div id="act_top">
		<a target="mainFrame" href="../functionList/teachingManage.jsp">教学管理</a>&nbsp;&gt;&gt;&nbsp;教学进度管理<a href="ChapterM.jsp">&nbsp;&gt;&gt;&nbsp;教学进度管理</a></div>
