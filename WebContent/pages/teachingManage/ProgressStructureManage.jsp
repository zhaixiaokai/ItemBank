...
<script type="text/javascript" src="../../servJs/TeachingProgressTreeOperate.js"
	charset="GBK"></script>
...
//	alert(CourseId);
	...
	function GetTeacherDepTree() {
		...
		$.ajax({
			...
			dataType : "json",
			async : false,
			url : "FunctionGetTeachingProgressTreeDataAction",
		...
		if(newText==""||newText==null){
			...
			if(confirm("确认修改？")){
	    		...
	    		$.ajax( {
	    			...
	    			data:"nodeid="+currentNode.data.id+"&node_explain="+newExplain+"&text="+newText+"&table="+"SYS_PROGRESS_TEACHING"+"&treeId="+currentNode.data.tree_id,
	    			success : function(result) {
	    				alert(result);
	    			},
	    			error:function(){
	...
	function ConfirmAddChild(){
   	...
   	function	getModifyNodeInfo(){
   	    ...
   	    document.getElementById("PannelHeader").innerHTML="修改教学进度结构信息";
   	...
   	function	getAddPreviousNodeInfo(){
   	    ...
   	    document.getElementById('fade').style.height=document.body.clientHeight+"px" ;
   	    document.getElementById('fade').style.display='block';
   	    document.getElementById("PannelHeader").innerHTML="添加前置进度节点";
   	...
   	function	getAddAfterNodeInfo(){
   	    ...
   	    document.getElementById('fade').style.height=document.body.clientHeight+"px" ;
   	    document.getElementById('fade').style.display='block';
   	    document.getElementById("PannelHeader").innerHTML="添加后置进度节点";
   	...
   	function	getAddChildNodeInfo(){
   	    ...
   	    document.getElementById('fade').style.height=document.body.clientHeight+"px" ;
   	    document.getElementById('fade').style.display='block';
   	    document.getElementById("PannelHeader").innerHTML="添加子进度节点";
...
<body class=" yui-skin-sam">
	...
	<div id="act_top">
		<a href="javascript:void(0)">教学管理</a>&nbsp;&gt;&gt;&nbsp;<a
			...
			href="javascript:void(0)">教学进度结构管理</a>
	</div>
	...
	<div id="act_content2">
		<div id="te1" style="width: 100%; height: 80px;">
			<a href="javascript:void(0)" onclick="addPreviousNode()">添加前置进度节点</a> <strong>|</strong>
			<a href="javascript:void(0)" onclick="addAfterNode()">添加后置进度节点</a><strong>|</strong>
			<a href="javascript:void(0)" onclick="modifyCurrentNode()">修改进度节点</a> <strong>|</strong>
			<a href="javascript:void(0)" onclick="deleteCurrentNode()">删除进度节点</a> <strong>|</strong>
			<a href="javascript:void(0)" onclick="cutCurrentNode()">剪切进度节点</a> <strong>|</strong>
			...
			<strong>|</strong> <a href="javascript:void(0)"
				...
				href="javascript:void(0)" onclick="PasteAsChildNode()">粘帖为子进度节点</a><strong>|</strong>
			<a href="javascript:void(0)" onclick="addChildeNode()">添加子进度节点</a>
