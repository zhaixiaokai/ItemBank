...
function DeleteRow(o){
	...
	if(confirm("确定要删除该记录？")){
		$.ajax({
			...
			dataType : "json",
			async : false,
			url : "TeachingMaterialDeleteAction?DeleteId="+id,
			success : function(result) {
				alert(result.result);
				//删除完成后重新载入数据表~
				CreateTeachingMaterialTableByCurseId(SpecialFieldId);
...
function BulkDelete(){
	...
	if(confirm("确定要删除？")){
		$.ajax( {
			...
			dataType : "json",
			async : false,
			url : "TeachingMaterialBulkDeleteAction",
			data:"DeleteId="+param,
			success : function(result) {
				alert(result.text);
				CreateTeachingMaterialTableByCurseId(SpecialFieldId);
	...
	(function () {
        ...
        YAHOO.widget.DataTable.Formatter.Delete = function(elCell, oRecord, oColumn, oData){
            ...
            elCell.innerHTML="<a href='#' name='"+Id+"' onclick='DeleteRow(this)'>删除</a> "
            	+"| <a href='#' name='"+Id+"' onclick=\"ModifyRow('"+Id+"','"+Name+"','"+Version+"','"+Author+"','"+Date+"','"+House+"','"+Code+"')\">修改</a>";
...
<body class=" yui-skin-sam">
	...
	<!-- 右侧界面 -->
	<div id="act_top">
		<a target="mainFrame" href="../functionList/teachingManage.jsp">教学管理</a>&nbsp;&gt;&gt;&nbsp;教材管理<a
			href="TeachingMaterialM.jsp">&nbsp;&gt;&gt;&nbsp;教材管理</a>
	</div>
	...
	<div id="act_content2">
		...
		<div id="container">
			<div id="panel1" style="z-index: 1999">
				<div class="hd" style="z-index: 2000">修改教材信息（标<span class="red"> *</span>为必填项）</div>
					...
					<form name="modifyForm" action="TeachingMaterialUpdateAction"
						...
						<table>
							<tr>
								...
								<td><input type="text" name="TeachingMaterialName" id="TeachingMaterialName" /><span class="red"> *</span></td>
							</tr>
							<tr>
								<td width="100px">教材编号：</td>
								<td><input type="text" name="TeachingMaterialID" id="TeachingMaterialID" /><span class="red"> *</span></td>
							</tr>
							<tr>
								<td width="100px">教材版本：</td>
								<td><input type="text" name="TeachingMaterialVersion" id="TeachingMaterialVersion" /><span class="red"> *</span></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="TeachingMaterialDate" id="TeachingMaterialDate" readOnly="true" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="TeachingMaterialCode" id="TeachingMaterialCode" /><span class="red"> *</span></td>
							</tr>
						</table>
						<div align="center">
