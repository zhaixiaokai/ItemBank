...
<body class=" yui-skin-sam">
	...
	<!-- 右侧界面 -->
	<div id="act_top">
		<a target="mainFrame" href="../functionList/teachingManage.jsp">教学管理</a>&nbsp;&gt;&gt;&nbsp;教材管理<a href="TeachingMaterialInquiry.jsp">&nbsp;&gt;&gt;&nbsp;教材查询</a></div>
					...
					<form name="modifyForm" action="TeachingMaterialUpdateAction"
						...
						<table>
							<tr>
								...
								<td><input type="text" name="TeachingMaterialName" id="TeachingMaterialName" disabled/></td>
							</tr>
							<tr>
								<td width="100px">教材编号：</td>
								<td><input type="text" name="TeachingMaterialID" id="TeachingMaterialID" disabled/></td>
							</tr>
							<tr>
								<td width="100px">教材版本：</td>
								<td><input type="text" name="TeachingMaterialVersion" id="TeachingMaterialVersion" disabled/></td>
							</tr>
							<tr>
								<td width="100px">教材作者：</td>
								<!-- <td><textarea id="TeachingMaterialAuthor" name="TeachingMaterialAuthor"></textarea></td> -->
								<td><input type="text" name="TeachingMaterialAuthor" id="TeachingMaterialAuthor" disabled/></td>
							</tr>
							<tr>
								<td width="100px">出版日期：</td>
								<td><input type="text" name="TeachingMaterialDate" id="TeachingMaterialDate" disabled/></td>
							</tr>
							<tr>
								<td width="100px">出版单位：</td>
								<td><input type="text" name="TeachingMaterialHouse" id="TeachingMaterialHouse" disabled/></td>
							</tr>
							<tr>
								<td width="100px">ISBN码：</td>
								<td><input type="text" name="TeachingMaterialCode" id="TeachingMaterialCode" disabled/></td>
							</tr>
						</table>
						<div align="center">
