...
function CreateCurseTableBySpecialFieldId(SpecialFieldId){
	(function () {
        ...
        YAHOO.widget.DataTable.Formatter.Delete = function(elCell, oRecord, oColumn, oData){
            ...
            elCell.innerHTML="<a href='#' name='"+Id+"' onclick=\"ModifyRow('"+Id+"','"+Name+"','"+Credit+"','"+Method+"','"+Explain+"')\">详细</a>";
...
<body class=" yui-skin-sam">
	...
	<!-- 右侧界面 -->
	<div id="act_top">
		<a target="mainFrame" href="../functionList/teachingManage.jsp">教学管理</a>&nbsp;&gt;&gt;&nbsp;课程管理<a href="CourseInquiry.jsp">&nbsp;&gt;&gt;&nbsp;课程查询</a></div>
	...
	<div id="act_content2">
		...
		<div id="container">
			<div id="panel1" style="z-index: 1999">
				<div class="hd" style="z-index: 2000">查看课程信息</div>
					...
					<form name="modifyForm" action="CurseUpdateAction"
						...
						<table>
							<tr>
								...
								<td><input type="text" name="CurseName" id="CurseName" disabled/></td>
							</tr>
							<tr>
								<td width="100px">课程编号：</td>
								<td><input type="text" name="CurseID" id="CurseID" disabled/></td>
							</tr>
							<tr>
								<td width="100px">课程学分：</td>
								<!-- <td><textarea id="CurseCredit" name="CurseCredit"></textarea></td> -->
								<td><input type="text" name="CurseCredit" id="CurseCredit" disabled/></td>
							</tr>
							<tr>
							    <td width="300px">考核方式: </td>
							    <td><input type="radio" id="RadioYes" checked name="radio" value="kaoshi" disabled>考试 
							        <input type="radio" id="RadioNo"  name="radio" value="kaocha" disabled>考查</td>
						        </tr>
							<tr>
								<td width="300px">备注说明: </td>
								<td><textarea id="CurseRemarks"
										name="CurseRemarks" rows="5" cols="70" disabled></textarea></td>
							</tr>
						</table>
						<div align="center">
