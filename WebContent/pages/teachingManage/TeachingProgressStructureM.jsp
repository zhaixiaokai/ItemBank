...
function CheckValidationAndQueryTeachingMaterial(){
	...
	window.location.href='ProgressStructureManage.jsp?SelectedCourseId='+SpecialFieldId;
...
function CreateTeachingMaterialTableByCurseId(SpecialFieldId){
	(function () {
        ...
        YAHOO.widget.DataTable.Formatter.Delete = function(elCell, oRecord, oColumn, oData){
            ...
            elCell.innerHTML="<a href='ChapterTree.jsp?SelectedCourseId="+SpecialFieldId+"&SelectedTeachingMaterialId="+Id+"' name='"+Id+"'>管理</a>";
...
<body class=" yui-skin-sam">
	...
	<!-- 右侧界面 -->
	<div id="act_top">
		<a target="mainFrame" href="../functionList/teachingManage.jsp">教学管理</a>&nbsp;&gt;&gt;&nbsp;教学进度管理<a href="TeachingProgressStructureM.jsp">&nbsp;&gt;&gt;&nbsp;教学进度结构管理</a></div>
